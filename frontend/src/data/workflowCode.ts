...
const goCode: CodeLine[] = [
  ...
  { text: '        compensations.Compensate(ctx)', indent: 1, step: 'release_payment_hold' },
  { text: '    }', indent: 1 },
  { text: '}()', indent: 1 },
  { text: '', indent: 0, isBlank: true },
...
const goHighlighting = [
  ...
  {
    pattern: /\b(workflow|temporal|RetryPolicy|Context|OrderInput|Result|Compensations)\b/g,
